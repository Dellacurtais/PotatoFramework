...
<body>
    <div id="notfound">
        <div class="notfound">
            ...
            <h2>Error <?=$Excpetion->getCode()?></h2>
            <p><?=nl2br($Excpetion->getMessage())?></p>
            <table>
                <tr>
                    <td><?=\System\Libraries\Lang::getInstance()->line("handler_error_file")?></td>
                    <td><?=$Excpetion->getFile()?></td>
                </tr>
                <tr>
                    <td><?=\System\Libraries\Lang::getInstance()->line("handler_error_line")?></td>
